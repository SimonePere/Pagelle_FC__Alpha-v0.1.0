/**
 * SCRIPT per sincronizzare manualmente PlayerLeaderboardStats con PlayerCardResult
 * Aggiorna direttamente le stats invece di usare gli hooks complessi
 */
...
async function manualSyncLeaderboard() {
    try {
        console.log('🔄 Starting manual PlayerLeaderboard sync...');
